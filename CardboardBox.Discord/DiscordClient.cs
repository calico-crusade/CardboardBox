...
public class DiscordClient : IDiscordClient
{
	...
	/// <summary>
	/// The bot's token from the config
	/// </summary>
	public string Token => _config["Discord:Token"] 
		?? throw new ArgumentNullException("Discord:Token", "The discord token is required to start the bot");
	...
	/// </summary>
	/// <param name="arg">The modal interaction</param>
	/// <returns>A task representing the completion of the modal interaction</returns>
    public Task Client_ModalSubmitted(SocketModal arg)
    {
		_modal.HandleModal(arg);
